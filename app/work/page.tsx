...
const ALL_PROJECTS = [
    {
        ...
        desc: "Creator and lead maintainer of LangChain's official LiteLLM integration. Started as my own repository; now developed and released inside the langchain-ai organization, with its own page in the LangChain docs and an entry in the Python API reference. One interface to 100+ providers, plus router-backed load balancing, embeddings and OCR loading. 15 million downloads across 27 releases, and around a million every month.",
