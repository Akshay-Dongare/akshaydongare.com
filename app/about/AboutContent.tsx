        ...
        >
            ...
            <div className="max-w-[820px] mx-auto px-6 md:px-10">
                ...
                >
                    ...
                    <p>
                        Before that I was lead developer on a WhatsApp assistant answering blood donation questions for users in Kenya, built under the Global Alliance for Medical Innovation at Harvard University. Almost nobody phrases a medical question the way a clinical document answers it, so the pipeline rewrites a query before it searches. I worked on that retrieval path, added guardrails for personal data and prompt injection, and ran a red-team pass covering injection, data exposure and medical accuracy before the system went to closed beta. It won Best Presentation at the Spring 2025 showcase.
                    </p>
                    <p>
                    ...
                    <div className="flex flex-col border-b border-line-8">
                        {[
                            ...
                            { year: "2025", text: "Lead developer, Kenya Blood Donation Assistant, Global Alliance for Medical Innovation at Harvard University. Best Presentation, Spring 2025 showcase" },
